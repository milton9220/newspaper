        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                  <h2 class="page-heading">Search : <?php echo $search_post; ?></h2>
                <?php
                    $limit=4;
                    ...
                    WHERE post.title LIKE '%{$search_post}%' OR post.description LIKE '%{$search_post}%' 
                ...
                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    <h3><a href='single.php?post_id=<?php echo $data['post_id']; ?>'><?php echo $data['title']; ?></a></h3>
                    ...
                    if(mysqli_num_rows($result1)>0){
                        ...
                        if($page > 1){ ?>
                            <li><a href="search.php?search=<?php echo $search_post; ?>&&page=<?php echo $page-1; ?>">Prev</a></li>
                        <?php }
                        ...
                        for($i=1;$i<=$total_pages;$i++){ 
                            ...
                            ?>
                           <li class="<?php echo $active ?>"><a  href="search.php?search=<?php echo $search_post; ?>&&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                       <?php }
                       if($total_pages > $page):?>
                        <li><a href="search.php?search=<?php echo $search_post; ?>&&page=<?php echo $page+1; ?>">Next</a></li>
                       <?php endif;
                        echo "</ul>";
